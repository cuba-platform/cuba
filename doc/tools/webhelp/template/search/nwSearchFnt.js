...
var no = 0;
var noWords = 0;
var partialSearch = "<font class=\"highlightText\">Не найдено страницы удовлетворяющей всему запросу.<br>Результаты:</font>";
var warningMsg = '<div style="padding: 5px;margin-right:5px;;background-color:#FFFF00;">';
warningMsg+='<b>Обратите внимание, что из-за настроек безопасности, Google Chrome не подсвечивает';
warningMsg+=' результаты поиска во фрейме.</b><br>';
warningMsg+='Это происходит только когда WebHelp находится на локальной файловой системе.<br>';
warningMsg+='Временные решения:';
warningMsg+='<ul>';
warningMsg+='<li>Попробуйте использовать другой браузер.</li>';
warningMsg+='<li>Разверните WebHelp на веб-сервере.</li>';
warningMsg+='</div>';
txt_filesfound = 'Результаты';
txt_enter_at_least_1_char = "Для поиска необходимо ввести хотя бы один символ.";
txt_enter_more_than_10_words = "Только первые 10 слов будут обработанны.";
txt_browser_not_supported = "WebHelp не поддерживает ваш браузер. Рекомендуется использовать Mozilla Firefox.";
txt_please_wait = "Пожалуйста подождите. Идет поиск...";
