// $ANTLR 3.5.2 JPA2.g 2019-08-07 19:08:48
...
public class JPA2Parser extends Parser {
	...
	public final JPA2Parser.select_statement_return select_statement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: where_clause, orderby_clause, having_clause, from_clause, groupby_clause, select_clause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final JPA2Parser.update_clause_return update_clause() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: update_item, identification_variable_declaration, SET, update_item, 66
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt41) {
				case 1 :
					...
					// AST REWRITE
					// elements: DISTINCT, aggregate_expression_function_name, RPAREN, arithmetic_expression, LPAREN
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: COUNT, RPAREN, DISTINCT, LPAREN, count_argument
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final JPA2Parser.subquery_return subquery() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: groupby_clause, 129, having_clause, simple_select_clause, where_clause, subquery_from_clause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
