// $ANTLR 3.5.2 JPA2.g 2019-10-14 15:32:51
...
public class JPA2Parser extends Parser {
	...
	public final JPA2Parser.select_statement_return select_statement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: where_clause, from_clause, orderby_clause, select_clause, groupby_clause, having_clause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final JPA2Parser.update_clause_return update_clause() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: SET, update_item, 66, identification_variable_declaration, update_item
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt41) {
				case 1 :
					...
					// AST REWRITE
					// elements: aggregate_expression_function_name, RPAREN, DISTINCT, LPAREN, arithmetic_expression
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final JPA2Parser.subquery_return subquery() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: having_clause, simple_select_clause, subquery_from_clause, where_clause, groupby_clause, 129
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
