...
/**
 * Autodetects Spring beans annotated with {@link JmxBean} and registers them with a JMX server.
 */
public class AnnotationMBeanExporter extends MBeanExporter {
    ...
    public void setAutodetect(boolean autodetect) {
        setAutodetectMode(autodetect ? AUTODETECT_ASSEMBLER : AUTODETECT_NONE);
    }
}