 ...
 *
 */
public interface FileStorageAPI<T extends FileDescriptor> {
     ...
     */
    long saveStream(T fileDescr, InputStream inputStream) throws FileStorageException;
     ...
     * @throws FileStorageException     if something goes wrong
     */
    void saveFile(T fileDescr, byte[] data) throws FileStorageException;
     ...
     * @throws FileStorageException     if something goes wrong
     */
    void removeFile(T fileDescr) throws FileStorageException;
     ...
     * @throws FileStorageException     if something goes wrong
     */
    InputStream openStream(T fileDescr) throws FileStorageException;
     ...
     * @throws FileStorageException     if something goes wrong
     */
    byte[] loadFile(T fileDescr) throws FileStorageException;
     ...
     * @throws IllegalArgumentException if arguments are incorrect
     */
    boolean fileExists(T fileDescr);
}
