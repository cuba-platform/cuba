...
package spec.cuba.web.optiondialog
...
import spec.cuba.web.optiondialog.screens.OptionDialogScreen

@SuppressWarnings('GroovyAccessibility')
class OptionDialogFacetTest extends UiScreenSpec {

    void setup() {
        exportScreensPackages(['spec.cuba.web.optiondialog.screens'])
    }
