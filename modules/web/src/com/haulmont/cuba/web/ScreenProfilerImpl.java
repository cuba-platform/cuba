...
import com.haulmont.cuba.web.widgets.ScreenProfiler;
...
@Component(ScreenProfilerImpl.NAME)
public class ScreenProfilerImpl implements ScreenProfiler {
    ...
    @Override
    public void setCurrentProfilerMarker(UI ui, @Nullable String profilerMarker) {
        if (ui instanceof AppUI) {
