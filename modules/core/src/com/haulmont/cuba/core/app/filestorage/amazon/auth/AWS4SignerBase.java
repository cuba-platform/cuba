...
public abstract class AWS4SignerBase {
    ...
    protected static String getCanonicalRequest(URL endpoint,
        ...
        return String.format("%s\n%s\n%s\n%s\n%s\n%s",
                httpMethod, getCanonicalizedResourcePath(endpoint), queryParameters,
                canonicalizedHeaders, canonicalizedHeaderNames, bodyHash);
    }
    ...
    protected static String getStringToSign(String scheme, String algorithm, String dateTime, String scope, String canonicalRequest) {
        return String.format("%s-%s\n%s\n%s\n%s",
                scheme, algorithm, dateTime, scope, BinaryUtils.toHex(hash(canonicalRequest)));
    }
