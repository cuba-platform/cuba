...
public class ProxyPreparedStatement<T extends PreparedStatement> extends ProxyStatement<T> implements PreparedStatement {

    public ProxyPreparedStatement(T statement, Connection connection) {
