...
import com.haulmont.cuba.core.sys.http.api.template.MetaClassRepresentation;
...
public class DataServiceController {
    ...
    @RequestMapping(value = "/find/{entityRef}", method = RequestMethod.GET)
    public void find(@PathVariable String entityRef,
                     @RequestParam(value = "s") String sessionId,
                     @RequestHeader(value = "Accept", required = false) MimeType requestedForm,
        ...
        try {
            ...
            if (entity == null) {
                ...
                Convertor convertor = conversionFabric.getConvertor(requestedForm);
    ...
    @RequestMapping(value = "/query/{entityName}", method = RequestMethod.GET)
    public void query(@PathVariable String entityName,
    ...
    public void commit(@RequestParam(value = "s") String sessionId,
        ...
        Convertor convertor = conversionFabric.getConvertor(contentType);
        try {
