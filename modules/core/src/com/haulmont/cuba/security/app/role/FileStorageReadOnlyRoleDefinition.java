 ...
 */
@Role(name = FileStorageReadOnlyRoleDefinition.ROLE_NAME)
public class FileStorageReadOnlyRoleDefinition extends AnnotatedRoleDefinition {

    public static final String ROLE_NAME = "system-file-storage-read-only";
    ...
    public String getLocName() {
        return "File storage read-only access";
    }
}
