...
public class DeleteCascadeEntityListener implements BeforeDeleteEntityListener<CascadeEntity> {
    ...
    @Override
    public void onBeforeDelete(CascadeEntity entity, EntityManager entityManager) {
