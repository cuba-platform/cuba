...
public class SearchComboBoxPainter extends BaseMandatoryRegionPainter {
    ...
    public SearchComboBoxPainter(PaintContext ctx, int state) {
        this.state = state;
        this.ctx = ctx;
    }

    public static SearchComboBoxPainter backgroundDisabledPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_DISABLED);
    }

    public static SearchComboBoxPainter backgroundDisabledPressedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_DISABLED_PRESSED);
    }

    public static SearchComboBoxPainter backgroundEnabledPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_ENABLED);
    }

    public static SearchComboBoxPainter backgroundFocusedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_FOCUSED);
    }

    public static SearchComboBoxPainter backgroundFocusedMouseOverPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_MOUSEOVER_FOCUSED);
    }

    public static SearchComboBoxPainter backgroundMouseOverPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_MOUSEOVER);
    }

    public static SearchComboBoxPainter backgroundFocusedPressedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_PRESSED_FOCUSED);
    }

    public static SearchComboBoxPainter backgroundPressedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_PRESSED);
    }

    public static SearchComboBoxPainter backgroundEnabledSelectedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(8, 9, 8, 19), new Dimension(83, 24), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_ENABLED_SELECTED);
    }

    public static SearchComboBoxPainter backgroundDisabledEditablePainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(6, 5, 6, 6), new Dimension(79, 21), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_DISABLED_EDITABLE);
    }

    public static SearchComboBoxPainter backgroundEnabledEditablePainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(6, 5, 6, 6), new Dimension(79, 21), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_ENABLED_EDITABLE);
    }

    public static SearchComboBoxPainter backgroundEditableFocusedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(5, 5, 5, 5), new Dimension(142, 27), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_FOCUSED_EDITABLE);
    }

    public static SearchComboBoxPainter backgroundEditableMouseOverPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(4, 5, 5, 4), new Dimension(79, 21), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_MOUSEOVER_EDITABLE);
    }

    public static SearchComboBoxPainter backgroundEditablePressedPainter() {
        return new SearchComboBoxPainter(new AbstractRegionPainterPaintContext(new Insets(4, 5, 5, 4), new Dimension(79, 21), false, "NINE_SQUARE_SCALE", Double.POSITIVE_INFINITY, 2.0), BACKGROUND_PRESSED_EDITABLE);
    }
    ...
    private Path2D decodePath6() {
        ...
        path.lineTo(decodeX(3.0f - 0.120000005f), decodeY(0.120000005f));
        path.lineTo(decodeX(3.0f - 0.120000005f), decodeY(3.0f - 0.120000005f));
        path.lineTo(decodeX(0.120000005f), decodeY(3.0f - 0.120000005f));
