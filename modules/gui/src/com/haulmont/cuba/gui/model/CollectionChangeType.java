...
public enum CollectionChangeType {
     ...
     * An event of this type contains information on what items were added.
     */
    ADD_ITEMS,

    /**
     * Some items were removed from the collection.
     * An event of this type contains information on what items were removed.
     */
    REMOVE_ITEMS,

    /**
     * An item was replaced in the collection.
     * An event of this type contains the new item.
     */
    SET_ITEM
}
