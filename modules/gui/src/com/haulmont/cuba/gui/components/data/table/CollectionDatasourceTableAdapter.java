...
public class CollectionDatasourceTableAdapter<E extends Entity<K>, K> implements EntityTableSource<E>, LegacyDataSource<E> {
    ...
    public CollectionDatasourceTableAdapter(CollectionDatasource<E, K> datasource) {
