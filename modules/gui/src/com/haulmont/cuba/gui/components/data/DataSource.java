...
public interface DataSource<T> {
    ...
    /**
     * An event that is fired when DataSource state is changed.
     *
    ...
    class StateChangeEvent<T> extends EventObject {
        ...
        public StateChangeEvent(DataSource<T> source, BindingState state) {
            super(source);
            this.state = state;
        }
        ...
        public DataSource<T> getSource() {
            return (DataSource<T>) super.getSource();
        }
