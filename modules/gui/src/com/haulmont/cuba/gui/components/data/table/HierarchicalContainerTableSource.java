...
public class HierarchicalContainerTableSource<E extends Entity>
            extends CollectionContainerTableSource<E>
            implements TreeTableSource<E> {

    private final String hierarchyProperty;

    public HierarchicalContainerTableSource(CollectionContainer<E> container, String hierarchyProperty) {
        super(container);
