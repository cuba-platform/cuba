...
@Component(AttributeSecurity.NAME)
public class AttributeSecurity {
    public static final String NAME = "cuba_AttributeSecurity";

    public void applyAttributeSecurity(Frame container) {
        ComponentsHelper.walkComponents(container, (component, name) -> {
            if (component instanceof DatasourceComponent) {
                visitComponent((DatasourceComponent) component);
            }
        });
    }

    protected void visitComponent(DatasourceComponent component) {
