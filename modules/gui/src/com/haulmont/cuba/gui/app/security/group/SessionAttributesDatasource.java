...
public class SessionAttributesDatasource extends CustomCollectionDatasource<SessionAttribute, UUID> {
    protected AccessGroupsService groupsService = AppBeans.get(AccessGroupsService.NAME);

    @Override
    protected Collection<SessionAttribute> getEntities(Map<String, Object> params) {
        return groupsService.getGroupAttributes((Group) params.get("group"));
    }
}
