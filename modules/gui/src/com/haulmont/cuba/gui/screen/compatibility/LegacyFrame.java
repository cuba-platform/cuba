...
public interface LegacyFrame extends Component.HasXmlDescriptor,
    ...
    /**
     * @return window manager of the screen
     */
    ...
    default AbstractFrame openFrame(@Nullable Component parent, String windowAlias) {
        WindowConfig windowConfig = AppBeans.get(WindowConfig.NAME);
        WindowInfo windowInfo = windowConfig.getWindowInfo(windowAlias);
        return (AbstractFrame) getWindowManager().openFrame(getWrappedFrame(), parent, windowInfo);
    }
    ...
    default AbstractFrame openFrame(@Nullable Component parent, String windowAlias, Map<String, Object> params) {
        WindowConfig windowConfig = AppBeans.get(WindowConfig.NAME);
        WindowInfo windowInfo = windowConfig.getWindowInfo(windowAlias);
        return (AbstractFrame) getWindowManager().openFrame(getWrappedFrame(), parent, windowInfo, params);
    }
