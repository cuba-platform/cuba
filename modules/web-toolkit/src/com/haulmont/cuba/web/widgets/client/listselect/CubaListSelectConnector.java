...
@Connect(value = CubaListSelect.class)
public class CubaListSelectConnector extends ListSelectConnector {
    ...
    @Override
    public CubaListSelectWidget getWidget() {
        return (CubaListSelectWidget) super.getWidget();
    }
}
