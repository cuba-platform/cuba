...
import com.haulmont.cuba.web.widgets.client.Properties;
...
public class CubaMultiUploadWidget extends FormPanel {
    ...
    protected native void setDefaultHandlers(Options opts) /*-{
        ...
        opts['swfupload_pre_load_handler'] = $entry(function() {
            swfu.@com.haulmont.cuba.web.widgets.client.multiupload.CubaMultiUploadWidget::swfLoaded()();
        });
        opts['swfupload_load_failed_handler'] = $entry(function() {
            swfu.@com.haulmont.cuba.web.widgets.client.multiupload.CubaMultiUploadWidget::swfLoadFailed()();
        });
        opts['upload_error_handler'] = $entry(function (file, errorCode, message) {
            swfu.@com.haulmont.cuba.web.widgets.client.multiupload.CubaMultiUploadWidget::errorNotify(Ljava/lang/String;Ljava/lang/String;I)(file.name, message, errorCode);
        });
        ...
        opts['queue_complete_handler'] = $entry(function (numFilesUploaded) {
            swfu.@com.haulmont.cuba.web.widgets.client.multiupload.CubaMultiUploadWidget::queueUploadComplete()();
        });
    }-*/;
