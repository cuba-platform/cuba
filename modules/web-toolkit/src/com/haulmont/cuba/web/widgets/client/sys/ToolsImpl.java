...
package com.haulmont.cuba.web.widgets.client.sys;
...
public class ToolsImpl {
    ...
    public native void textSelectionEnable(Element el, boolean enable) /*-{
        ...
        if (!enable) {
            walkEach(el, ToolsImpl.@com.haulmont.cuba.web.widgets.client.sys.ToolsImpl::setTextSelectionDisable(Lcom/google/gwt/dom/client/Element;));
        } else {
            walkEach(el, ToolsImpl.@com.haulmont.cuba.web.widgets.client.sys.ToolsImpl::setTextSelectionEnable(Lcom/google/gwt/dom/client/Element;));
        }
