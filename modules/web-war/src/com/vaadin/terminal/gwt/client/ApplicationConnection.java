...
public class ApplicationConnection {
    ...
    public boolean updateComponent(Widget component, UIDL uidl,
        ...
        setElementId(component.getElement(), uidl.getId());
        ...
        styleBuf.append(component.getStyleName());
    ...
    public void setElementId(Element element, String id) {
        if (configuration.useDebugIdInDOM() && id.startsWith("PID_S")) {
            DOM.setElementProperty(element, "id", id.substring(5));
        }
    }
