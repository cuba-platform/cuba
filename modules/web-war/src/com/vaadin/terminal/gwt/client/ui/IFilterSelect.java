...
public class IFilterSelect extends Composite implements Paintable, Field,
    ...
    protected int textboxPadding = -1;
    ...
    protected void updateAttributes(UIDL uidl) {
        //it should overrided in children
    }
    ...
    protected void setTextboxWidth(int componentWidth) {
    ...
    protected int getTextboxPadding() {
        if (textboxPadding < 0) {
    ...
    protected int getComponentPadding() {
