...
public interface ClientConfig extends Config {
    ...
    @Source(type = SourceType.DATABASE)
    @Default("[filters_popup] [add_condition] [spacer] [settings | save, save_with_values, save_as, edit, remove, make_default, pin, save_search_folder, save_app_folder, clear_values] [max_results] [fts_switch]")
     ...
     * @return ExcelExportFormat.XLS or ExcelExportFormat.XLSX value
     */
