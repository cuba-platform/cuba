...
public class TestAdditionalCriteriaProvider implements AdditionalCriteriaProvider {
    ...
    public boolean requiresAdditionalCriteria(Class entityClass) {
        ...
        return className.equals("com.haulmont.cuba.testmodel.entity_cache.ParentCachedEntity")
                || className.equals("com.haulmont.cuba.testmodel.entity_cache.ChildCachedEntity")
                || className.equals("com.haulmont.cuba.testmodel.entity_cache.ChildAttribute");
    }
