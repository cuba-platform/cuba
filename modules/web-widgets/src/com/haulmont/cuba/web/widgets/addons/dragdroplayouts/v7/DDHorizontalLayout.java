 ...
 * the License.
 */
package com.haulmont.cuba.web.widgets.addons.dragdroplayouts.v7;

import java.util.Map;

import com.haulmont.cuba.web.widgets.client.addons.dragdroplayouts.ui.util.SharedConstants;
...
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.DDUtil;
...
import com.haulmont.cuba.web.widgets.client.addons.dragdroplayouts.v7.ui.horizontallayout
        .DDHorizontalLayoutState;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.events.LayoutBoundTransferable;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.interfaces.DragFilter;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.interfaces.DragFilterSupport;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.interfaces.DragImageProvider;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.interfaces.DragImageReferenceSupport;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.interfaces.LayoutDragSource;
import com.haulmont.cuba.web.widgets.addons.dragdroplayouts.interfaces.ShimSupport;
...
public class DDHorizontalLayout extends HorizontalLayout
    ...
    public void paintContent(PaintTarget target) throws PaintException {
        ...
        // Haulmont API. The constant was extracted into a separate class
        // Shims
        target.addAttribute(SharedConstants.SHIM_ATTRIBUTE,
