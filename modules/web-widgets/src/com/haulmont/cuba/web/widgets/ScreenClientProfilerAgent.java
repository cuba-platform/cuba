...
public class ScreenClientProfilerAgent extends AbstractExtension {
    ...
    public ScreenClientProfilerAgent(ScreenProfiler screenProfiler) {
        this.screenProfiler = screenProfiler;

        registerRpc((ScreenClientProfilerServerRpc) screenProfiler::flush);
    }
