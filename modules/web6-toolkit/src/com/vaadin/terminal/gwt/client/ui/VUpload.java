...
public class VUpload extends SimplePanel implements Paintable {
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        String windowNameParameter = "";
        if (uidl.hasAttribute("windowName"))
            windowNameParameter = "?windowName=" + uidl.getStringAttribute("windowName");

        final String action = client.translateVaadinUri(uidl
                .getStringVariable("action")) + windowNameParameter;
        ...
        if(uidl.hasAttribute("buttonwidth"))
