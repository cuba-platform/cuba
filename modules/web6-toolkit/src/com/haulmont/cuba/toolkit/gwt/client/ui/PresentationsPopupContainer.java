...
/**
 * Custom popup container for presentations menu
 *
 * @author artamonov
 * @version $Id$
 */
public class PresentationsPopupContainer extends VOverlay implements Container {

    private ApplicationConnection client;
    private Widget component;
    private UIDL uidl;

    public PresentationsPopupContainer() {
